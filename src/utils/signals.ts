...
export const signChange: ActionFactory = ({reloadPage = true}) => ({type: SIGN_CHANGE, payload: {reloadPage}});
export const signReload: ActionFactory = () => ({type: SIGN_RELOAD});
export const signReloaded: ActionFactory = (msg: string) => ({type: SIGN_RELOADED, payload: msg});
export const signLog: ActionFactory = (msg: string) => ({type: SIGN_LOG, payload: msg});