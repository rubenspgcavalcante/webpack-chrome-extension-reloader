...
import {BACKGROUND_ENTRY, CONFIG, CONTENT_SCRIPT_ENTRY, NO_PAGE_RELOAD, PORT} from "./args.constant";
import {
...
const contentScript = params[CONTENT_SCRIPT_ENTRY] || DEFAULT_CONTENT_SCRIPT_ENTRY;
...
const compiler = webpack(typeof opts === 'function' ? opts(process.env, process.argv) : opts);
